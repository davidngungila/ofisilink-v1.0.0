...
@section('title', 'Profile & Image Settings - OfisiLink')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="mb-3 mb-md-0">
            <h3 class="mb-2 text-white fw-bold">
              <i class="bx bx-user me-2"></i>Profile & Image Settings
            </h3>
...
@include('admin.settings-partials.profile', ['adminUser' => $adminUser])
