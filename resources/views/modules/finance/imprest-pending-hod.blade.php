...
<div class="container-fluid px-4 py-3">
        ...
        <div class="card-body text-white">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    ...
                    <p class="mb-0 opacity-90">Review and approve imprest requests pending your approval</p>
                </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('imprest.pending-hod') }}" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="{{ route('imprest.pending-hod') }}" class="btn btn-secondary">
