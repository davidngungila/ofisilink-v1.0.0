...
<div class="db-breadcrumb">
    <h4 class="breadcrumb-title">Pending Verification</h4>
...
<div class="container-fluid px-4 py-3">
        ...
        <div class="card-body text-white">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    ...
                    <p class="mb-0 opacity-90">Verify submitted receipts for imprest requests</p>
                </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('imprest.pending-verification') }}" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="{{ route('imprest.pending-verification') }}" class="btn btn-secondary">
